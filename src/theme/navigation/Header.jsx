...
class Header extends React.Component {
    ...
    componentDidMount() {
        header_area = document.getElementById('app-header-area');
    ...
    render() {
        ...
        return (
            <header>
                {/* Header Start */}
                <div className="header-area bg-white" id="app-header-area">
                                ...
                                <div className="row mx-0">
                                    <div className="col-2 d-block d-md-none d-lg-none d-xl-none">
                                        ...
                                        {path != '/' && <div className="text-primary w-100 h-100 d-flex justify-content-center align-items-center navbar-toggler" style={{ fontSize: '130%' }}>
                                            <Link to="/" class="d-block text-primary" ><span className="fas fa-arrow-left"></span></Link>
                                        </div>}
                                    </div>
                                    <div className="col-8 col-lg-10 col-md-12 header-flex">
                                        <div className="row mx-0">
                                            <div className="col-12 d-block d-md-none d-lg-none d-xl-none px-0">
                                                {header_name !== '' && <div class="d-flex justify-content-center align-items-center w-100 py-3">{header_name}</div>}
                                                {header_name === '' && <Link to="/" class="w-100"><img src={logo} alt="" className="img-fluid my-1" /></Link>}
                                            </div>
                                    ...
                                    <div className="col-12 d-block d-md-none d-lg-none d-xl-none px-0">
                                        <div className="position-absolute" style={{ left: '0px', right: '0px' }}>
                                            <nav class="navbar navbar-expand-lg navbar-light bg-white p-0 shadow-sm">
                                                <div id="navbarContent" class="collapse navbar-collapse mobile-menu">
                                                    <ul class="navbar-nav mx-auto px-2">
                                                        <li class="nav-item"><Link to="/" data-toggle="collapse" data-target="#navbarContent" className="nav-link">Home</Link></li>
                                                        <li class="nav-item"><Link to="/page" data-toggle="collapse" data-target="#navbarContent" className="nav-link">Page 1</Link></li>
                                                        <li class="nav-item"><Link to="/page" data-toggle="collapse" data-target="#navbarContent" className="nav-link">Page 2</Link></li>
                                                        <li class="nav-item"><Link to="/page" data-toggle="collapse" data-target="#navbarContent" className="nav-link">Page 3</Link></li>
                                                        <li class="nav-item"><Link to="/page" data-toggle="collapse" data-target="#navbarContent" className="nav-link">Page 4</Link></li>
                                                    </ul>
                                                </div>
                                            </nav>
                                        </div>
